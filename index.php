        ...
        <div class="layout">
            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="index.php">
                        <img class="img-fluid col-10 " src="assets/images/logo/<?= $information['logo'] ?>" alt="Logo">
                        <img class="logo-fold img-fluid col-12 mt-3" src="assets/images/logo/<?= $information['icon'] ?>" alt="Logo">
                    </a>
                </div>
